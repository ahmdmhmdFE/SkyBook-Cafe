// Change Colors By Setting Box And Bulletts
...
// Change Background Image In Landing Page
...
window.onscroll = function () {
  ...
  if (windowScrollTop > (salesOffsetTop + salesOuterHeight - windowHeight)) {
    let allSales = document.querySelectorAll(".sales-box .sales-progress span");
